    ...
    for (var i = 0; i < list.length / 8; i++) {
      ...
      try {
        ...
        sending.map((n) => {
          ...
          setFeedbackStatus(
            "🤝 SUCCESS SER! If BULK packaged, wait for all of it to finish."
          );
        });
      } catch (e) {
    ...
    <>
      ...
      <div
        ...
        className={
          !allowed
            ? "hidden"
            : " bg-[#09101B] fixed  rounded-md flex flex-col p-8 mt-16 h-screen mx-20 shadow-slate-400 shadow-xl"
        }
      >
          ...
          <div className="flex justify-between">
            <div id="counter">
              <div className="ml-10 flex flex-col items-center">
                <h2>
                  {sending.length}/{nfts.length} selected
                </h2>

                <input
                  type="text"
                  className="mt-2 rounded text-slate-800"
            ...
            <div id="transferTo" className="flex flex-col mr-5 gap-2">
              ...
              >
                <BiTransfer className="mr-2"> </BiTransfer>
                <p className="font-bold">Transfer items</p>
              </button>
            </div>
          </div>
        </div>
        ...
        <div
          id="items"
          className="text-white overflow-x-hidden bg-slate-900 shadow-xl rounded-xl mt-10"
        >
