...
export async function findEmptyTokenAccounts(connection: sweb3.Connection, owner: sweb3.PublicKey) : Promise<EmptyAccount[]> {
    const response = await connection.getTokenAccountsByOwner(owner,{programId: TOKEN_PROGRAM_ID});
...
export async function createCloseEmptyAccountsTransactions(
    owner: sweb3.PublicKey, 
    accountPKs: sweb3.PublicKey[], 
    cntAccount?: sweb3.PublicKey, 
    program?: anchor.Program, 
    donationPercentage?: number, 
    donationAddress?: sweb3.PublicKey): Promise<sweb3.Transaction[]> {
